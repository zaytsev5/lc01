$(document).ready(function () {
  ...
  async function getAllKhachHang() {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      $("#table-khachhang").append(
        '<tr class="onRow" height="50px">' + element
      );
    }
  ...
  function checkChuyenXe() {
    ...
    for (var i = 0; i < dsMaCX.length; i++) {
      if (
        $("#BienSoXe-ChuyenXe").val() == dsBienSoXe_cx[i] &&
        d == dsNgayDi[i] &&
        String($("#GioDi").val()) == dsGioDi[i]
      )
        return false;
    }
    return true;
  ...
  $("#buttonInsertXe").click(function () {
    ...
    if ($("#BienSoXe").val() == "") {
      ...
      if (checkBienSoXe() == false)
        $("#warning").append("BienSoXe không được trùng !!");
      else {
  ...
  $("#buttonUpdateXe").click(function () {
    if ($("#BienSoXe").val() == "") {
      ...
      if (checkBienSoXe() == true)
        $("#warning").append("BienSoXe không tồn tại !!");
      else {
  ...
  $("#buttonInsertTuyenXe").click(function () {
    if (false) {
      ...
      if (checkMaTX() == false)
        $("#warningMaTX").append("MaTX không được trùng");
      else {
        fetch("http://localhost:5000/tuyenxe", {
          ...
          body: JSON.stringify({
            MaTX: Math.random().toString(36).slice(-4).toUpperCase(),
            DiemDi: $("#DiemDi").val(),
            DiemDen: $("#DiemDen").val(),
            DonGia: $("#DonGia").val(),
          }),
  ...
  $("#buttonUpdateTuyenXe").click(function () {
    if ($("#MaTX").val() == "") {
      ...
      if (checkMaTX() == true) $("#warningMaTX").append("MaTX không tồn tại");
        ...
        alert(`Tuyến xe đã được cập nhật `);
        location.reload();
      }
    }
  });
  ...
  $("#buttonInsertChuyenXe").click(function () {
    if (false) {
      ...
      if (checkMaCX() == false)
        $("#warningMaCX").append("MaCX không được trùng");
      else {
        fetch("http://localhost:5000/chuyenxe", {
          ...
          body: JSON.stringify({
            MaCX: $("#MaCX").val() || Math.random().toString(36).slice(-4).toUpperCase(),
  ...
  $("#buttonUpdateChuyenXe").click(function () {
    if ($("#MaCX").val() == "") {
      ...
      if (checkMaCX() == true) $("#warningMaCX").append("MaCX không tồn tại");
        ...
        alert(`Chuyến xe đã được cập nhật `);
        location.reload();
      }
    }
  });
  $("#buttonDeleteChuyenXe").click(function () {
    if ($("#MaCX").val() == "") {
      ...
      if (checkMaCX() == true) $("#warningMaCX").append("MaCX không tồn tại");
        ...
        .then(data => {
          if(data.status)
            return alert(`Chuyến xe Đã Xóa`);
           alert(`Không thể xoa chuyến xe này `);
        }).catch(() =>  {
